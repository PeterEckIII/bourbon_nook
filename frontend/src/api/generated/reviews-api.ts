...
export const reviewByBottleId = (
 ...
 signal?: AbortSignal
      ...
      return customReviewsInstance<ReviewResponseModel>(
      {url: `/reviews/bottle/${bottleId}`, method: 'GET', signal
    },
      );
    }
...
export const getReviewByBottleIdQueryKey = (bottleId: string,) => {
    return [
    `/reviews/bottle/${bottleId}`
    ] as const;
    }


export const getReviewByBottleIdQueryOptions = <TData = Awaited<ReturnType<typeof reviewByBottleId>>, TError = unknown>(bottleId: string, options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof reviewByBottleId>>, TError, TData>>, }
) => {

const {query: queryOptions} = options ?? {};

  const queryKey =  queryOptions?.queryKey ?? getReviewByBottleIdQueryKey(bottleId);



    const queryFn: QueryFunction<Awaited<ReturnType<typeof reviewByBottleId>>> = ({ signal }) => reviewByBottleId(bottleId, signal);





   return  { queryKey, queryFn, enabled: bottleId !== null && bottleId !== undefined, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof reviewByBottleId>>, TError, TData> & { queryKey: DataTag<QueryKey, TData, TError> }
}

export type ReviewByBottleIdQueryResult = NonNullable<Awaited<ReturnType<typeof reviewByBottleId>>>
export type ReviewByBottleIdQueryError = unknown


export function useReviewByBottleId<TData = Awaited<ReturnType<typeof reviewByBottleId>>, TError = unknown>(
 bottleId: string, options: { query:Partial<UseQueryOptions<Awaited<ReturnType<typeof reviewByBottleId>>, TError, TData>> & Pick<
        DefinedInitialDataOptions<
          Awaited<ReturnType<typeof reviewByBottleId>>,
          TError,
          Awaited<ReturnType<typeof reviewByBottleId>>
        > , 'initialData'
      >, }
...
export function useReviewByBottleId<TData = Awaited<ReturnType<typeof reviewByBottleId>>, TError = unknown>(
 bottleId: string, options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof reviewByBottleId>>, TError, TData>>, }
 , queryClient?: QueryClient
  ):  UseQueryResult<TData, TError> & { queryKey: DataTag<QueryKey, TData, TError> }
...
export function useReviewByBottleId<TData = Awaited<ReturnType<typeof reviewByBottleId>>, TError = unknown>(
 ...
 , queryClient?: QueryClient
  ...
  const queryOptions = getReviewByBottleIdQueryOptions(bottleId,options)
...
export const getReviewByBottleIdSuspenseQueryOptions = <TData = Awaited<ReturnType<typeof reviewByBottleId>>, TError = unknown>(bottleId: string, options?: { query?:Partial<UseSuspenseQueryOptions<Awaited<ReturnType<typeof reviewByBottleId>>, TError, TData>>, }
) => {
...
const {query: queryOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getReviewByBottleIdQueryKey(bottleId);
   ...
   return  { queryKey, queryFn, ...queryOptions} as UseSuspenseQueryOptions<Awaited<ReturnType<typeof reviewByBottleId>>, TError, TData> & { queryKey: DataTag<QueryKey, TData, TError> }
}

export type ReviewByBottleIdSuspenseQueryResult = NonNullable<Awaited<ReturnType<typeof reviewByBottleId>>>
export type ReviewByBottleIdSuspenseQueryError = unknown


export function useReviewByBottleIdSuspense<TData = Awaited<ReturnType<typeof reviewByBottleId>>, TError = unknown>(
 bottleId: string, options: { query:Partial<UseSuspenseQueryOptions<Awaited<ReturnType<typeof reviewByBottleId>>, TError, TData>>, }
 , queryClient?: QueryClient
  ):  UseSuspenseQueryResult<TData, TError> & { queryKey: DataTag<QueryKey, TData, TError> }
export function useReviewByBottleIdSuspense<TData = Awaited<ReturnType<typeof reviewByBottleId>>, TError = unknown>(
 bottleId: string, options?: { query?:Partial<UseSuspenseQueryOptions<Awaited<ReturnType<typeof reviewByBottleId>>, TError, TData>>, }
...
export function useReviewByBottleIdSuspense<TData = Awaited<ReturnType<typeof reviewByBottleId>>, TError = unknown>(
 ...
 , queryClient?: QueryClient
  ...
  const queryOptions = getReviewByBottleIdSuspenseQueryOptions(bottleId,options)
